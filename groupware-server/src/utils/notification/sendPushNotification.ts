...
const sendPushNotifToSpecificDevices = async (
  ...
  const dataToSend: PushNotifications.Data = {
    ...
    icon: 'https://portal.bold.ne.jp/_next/image?url=%2F_next%2Fstatic%2Fimage%2Fpublic%2Fvalleyin-logo.22bda447bf8117298663d36dd31fcf59.png&w=1080&q=75', // gcm for android
