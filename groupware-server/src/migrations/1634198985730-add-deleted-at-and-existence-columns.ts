...
export class addDeletedAtAndExistenceColumns1634198985730
  implements MigrationInterface
{
  name = 'addDeletedAtAndExistenceColumns1634198985730';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE users ADD existence int NULL DEFAULT '1'`,
    );
    await queryRunner.query(
